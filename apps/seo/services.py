...
INDUSTRY_RULES = {
    ...
    "restaurant_food": {
        ...
        "priority_page_types": ["menu", "location", "service", "review", "faq"],
        "goal_focus": "local dining intent, menu discovery, and reservation-ready searches",
    },
    "ecommerce": {
        "label": "Ecommerce",
    ...
    "legal": {
        "label": "Legal",
        "priority_page_types": ["service", "faq", "about", "pricing", "location"],
        "goal_focus": "trust-led local intent and practice-area comparison searches",
    },
    "education": {
        "label": "Education",
        "priority_page_types": ["service", "pricing", "location", "article", "faq"],
        "goal_focus": "course discovery, program comparison, and enrollment-intent searches",
    },
    "finance": {
        "label": "Finance / Fintech",
        "priority_page_types": ["service", "pricing", "comparison", "article", "faq"],
        "goal_focus": "trust-led financial queries and product comparison intent",
    },
    "beauty_wellness": {
        "label": "Beauty / Wellness",
        "priority_page_types": ["service", "pricing", "location", "review", "faq"],
        "goal_focus": "local booking intent and treatment-specific discovery searches",
    },
    "construction": {
        "label": "Construction / Trades",
        "priority_page_types": ["service", "location", "pricing", "review", "faq"],
        "goal_focus": "local contractor searches and project-intent queries",
    },
    "manufacturing": {
        "label": "Manufacturing / Industrial",
        "priority_page_types": ["service", "inventory", "pricing", "about", "faq"],
        "goal_focus": "B2B procurement searches and supplier comparison intent",
    },
    "media": {
        "label": "Media / Publishing",
        "priority_page_types": ["article", "service", "about", "pricing", "feature"],
        "goal_focus": "topic authority, audience discovery, and editorial reach",
    },
    "travel": {
        "label": "Travel / Tourism",
        "priority_page_types": ["service", "location", "pricing", "review", "faq"],
        "goal_focus": "destination intent, package comparison, and booking-ready searches",
    },
    "events": {
        "label": "Events / Entertainment",
        "priority_page_types": ["event", "pricing", "location", "faq", "amenity"],
        "goal_focus": "local event-booking intent, venue comparison, and package searches",
    },
    "nonprofit": {
        "label": "Nonprofit / NGO",
        "priority_page_types": ["about", "service", "article", "faq", "contact"],
        "goal_focus": "cause discovery, trust-building, and donation or volunteer-intent searches",
    },
    "other": {
...
BUSINESS_TYPE_KEYWORDS = {
    ...
    "saas": ["software", "platform", "dashboard", "product", "features", "subscription", "app", "saas"],
    "hotel": ["hotel", "stay", "room", "rooms", "booking", "suite", "amenity", "resort"],
    "restaurant_food": ["restaurant", "cafe", "food", "menu", "dining", "catering", "bakery", "eat", "cuisine", "beverage"],
    "ecommerce": ["shop", "store", "product", "products", "checkout", "cart", "collection", "buy"],
    "healthcare": ["clinic", "care", "doctor", "patient", "appointment", "medical", "health", "hospital", "pharmacy"],
    ...
    "legal": ["law", "lawyer", "attorney", "legal", "firm", "counsel", "solicitor", "court", "litigation"],
    "education": ["school", "academy", "education", "learning", "courses", "training", "tutoring", "university", "college"],
    "finance": ["finance", "financial", "investment", "insurance", "accounting", "bank", "loan", "mortgage", "fintech", "advisor"],
    "beauty_wellness": ["salon", "spa", "beauty", "wellness", "hair", "nails", "massage", "grooming", "barbershop", "skincare"],
    "construction": ["contractor", "construction", "builder", "renovation", "roofing", "plumbing", "electrician", "installation"],
    "manufacturing": ["manufacturer", "manufacturing", "supplier", "industrial", "factory", "wholesale", "production", "fabrication"],
    "media": ["media", "news", "blog", "publication", "content", "magazine", "podcast", "digital", "editorial"],
    "travel": ["tour", "travel", "tourism", "safari", "adventure", "trip", "package", "itinerary", "destination"],
    "events": ["event", "events", "venue", "garden", "gardens", "wedding", "conference", "party", "entertainment"],
    "nonprofit": ["nonprofit", "charity", "foundation", "ngo", "organization", "community", "donation", "volunteer", "cause"],
}
...
BUSINESS_TYPE_KEYWORD_TEMPLATES = {
    ...
    "agency": {
        ...
        "page_types": {
            "service": "{service} services {location}",
            "pricing": "{service} agency pricing {location}",
            "case_study": "{service} results {location}",
            "faq": "{service} agency faq",
            "comparison": "best {service} agency {location}",
        },
    },
    "saas": {
        "core": [
        ...
        "page_types": {
            ...
            "comparison": "{service} vs competitors",
            "use_case": "{service} for {audience}",
            "faq": "{service} software faq",
        },
    },
    "hotel": {
        "core": [
        ...
        "page_types": {
            "room": "rooms at {service} {location}",
            "event": "events at {service} {location}",
            "amenity": "{service} amenities {location}",
            "location": "hotel in {location}",
            "faq": "{service} {location} faq",
        },
    },
    "restaurant_food": {
        ...
        "page_types": {
            "menu": "{service} menu {location}",
            "location": "{service} in {location}",
            "service": "catering {location}",
            "review": "best {service} {location}",
            "faq": "{service} {location} faq",
        },
    },
    "ecommerce": {
        ...
        "page_types": {
            "category": "{service} collection {location}",
            "pricing": "{service} price {location}",
            "comparison": "best {service} brands",
            "faq": "{service} shop faq",
            "article": "{service} buying guide",
        },
    },
    "healthcare": {
        "core": [
        ...
        "page_types": {
            "service": "{service} treatment {location}",
            "location": "{service} clinic {location}",
            "faq": "{service} questions {location}",
            "article": "{service} health guide",
            "about": "top {service} doctors {location}",
        },
    },
    "real_estate": {
        "core": [
        ...
        "page_types": {
            ...
            "service": "real estate services {location}",
            "faq": "real estate faq {location}",
            "article": "property guide {location}",
            "comparison": "best real estate agent {location}",
        },
    },
    "local_service": {
        "core": [
        ...
        "page_types": {
            "service": "{service} services {location}",
            "pricing": "{service} prices {location}",
            "location": "{service} in {location}",
            "review": "best {service} {location}",
            "faq": "{service} faq {location}",
        },
    },
    "legal": {
        "core": [
            "{service} lawyer {location}",
            "best {service} attorney {location}",
            "{service} law firm {location}",
            "law firm {location}",
            "{service} legal advice {location}",
        ],
        "page_types": {
            "service": "{service} lawyer {location}",
            "faq": "{service} legal questions {location}",
            "about": "top law firms {location}",
            "pricing": "{service} lawyer fees {location}",
            "comparison": "best {service} lawyer {location}",
        },
    },
    "education": {
        "core": [
            "{service} {location}",
            "best {service} courses {location}",
            "{service} school {location}",
            "learn {service} {location}",
            "online {service} training",
        ],
        "page_types": {
            "service": "{service} courses {location}",
            "pricing": "{service} tuition fees {location}",
            "location": "{service} school {location}",
            "article": "{service} learning guide",
            "faq": "{service} training faq",
        },
    },
    "finance": {
        "core": [
        ...
        "page_types": {
            "service": "{service} services {location}",
            "pricing": "{service} fees {location}",
            "comparison": "best {service} company {location}",
            "article": "{service} advice {location}",
            "faq": "{service} {location} faq",
        },
    },
    "beauty_wellness": {
        ...
        "page_types": {
            "service": "{service} treatments {location}",
            "pricing": "{service} prices {location}",
            "location": "{service} salon {location}",
            "review": "best {service} {location}",
            "faq": "{service} {location} faq",
        },
    },
    "construction": {
        ...
        "page_types": {
            "service": "{service} services {location}",
            "pricing": "{service} quotes {location}",
            "location": "{service} contractor {location}",
            "review": "best {service} contractor {location}",
            "faq": "{service} contractor faq {location}",
        },
    },
    "manufacturing": {
        "core": [
            ...
            "industrial {service} {location}",
        ],
        "page_types": {
            "service": "{service} manufacturing {location}",
            "inventory": "{service} products {location}",
            "pricing": "{service} wholesale pricing",
            "about": "{service} manufacturer {location}",
            "faq": "{service} supply faq",
        },
    },
    "media": {
        "core": [
        ...
        "page_types": {
            "article": "{service} news {location}",
            "service": "{service} media {location}",
            "about": "{service} publication {location}",
            "pricing": "{service} advertising {location}",
            "feature": "{service} content platform",
        },
    },
    "travel": {
        "core": [
    ...
    "nonprofit": {
        "core": [
            ...
            "donate to {service} {location}",
        ],
        "page_types": {
            "about": "{service} organization {location}",
            "service": "{service} programs {location}",
            "article": "{service} impact {location}",
            "faq": "{service} donation faq",
            "contact": "{service} volunteer {location}",
        },
    },
}
