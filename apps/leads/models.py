...
class AuditRequest(TimestampedModel):
    ...
    business_subtype = models.CharField(max_length=160, blank=True)
    location = models.CharField(max_length=160, blank=True)
    location_mode = models.CharField(max_length=24, blank=True, default="targeted")
    location_country = models.CharField(max_length=2, blank=True)
    location_scope = models.CharField(max_length=24, blank=True)
    location_area = models.CharField(max_length=160, blank=True)
